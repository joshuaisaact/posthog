...
export function ModeSelector(): JSX.Element | null {
    const { agentMode, supermode, deepResearchMode } = useValues(maxThreadLogic)
    ...
    // Hide mode selector when in plan supermode - the agent controls the mode during planning
    // Must be after all hooks to comply with React Rules of Hooks
    if (supermode === AgentMode.Plan) {
        return null
    }
